...
// Producer is a type for structs that holds 2 channels: one for pizzas, with all
...
// Close is simply a method for closing the channel when we are done with it (i.e.
...
// and put in 2 cases where we can't make the pizza in time. Otherwise,
...
func pizzeria(pizzaMaker *Producer) {
	...
	// this loop will continue to execute, typing to make pizzas,
